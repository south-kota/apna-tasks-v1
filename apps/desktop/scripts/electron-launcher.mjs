// This file mostly exists because we want dev mode to say "Apna Tasks (Dev)" instead of "electron"
...
const devBundleIdSuffix = NodePath.basename(repoRoot)
  .toLowerCase()
  .replaceAll(/[^a-z0-9]+/g, "");
export const APP_DISPLAY_NAME = isDevelopment ? "Apna Tasks (Dev)" : "Apna Tasks (Alpha)";
export const APP_BUNDLE_ID = isDevelopment
  ? `com.apnatasks.desktop.dev.${devBundleIdSuffix || "local"}`
  : "com.apnatasks.desktop";
const APP_PROTOCOL_SCHEMES = isDevelopment ? ["apnatasks-dev"] : ["apnatasks"];
