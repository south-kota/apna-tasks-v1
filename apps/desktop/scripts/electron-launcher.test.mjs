...
describe("electron development launcher", () => {
  ...
  it("keeps the native Electron executable name inside the branded macOS bundle", () => {
    const paths = resolveMacLauncherPaths(
      "/repo/apps/desktop/.electron-runtime/Apna Tasks (Dev).app",
      "Apna Tasks (Dev)",
    );

    assert.equal(paths.launcherExecutableName, "Apna Tasks (Dev) Launcher");
    assert.equal(
      paths.launcherBinaryPath,
      "/repo/apps/desktop/.electron-runtime/Apna Tasks (Dev).app/Contents/MacOS/Apna Tasks (Dev) Launcher",
    );
    assert.equal(
      paths.runtimeElectronBinaryPath,
      "/repo/apps/desktop/.electron-runtime/Apna Tasks (Dev).app/Contents/MacOS/Electron",
    );
    ...
    assert.include(
      script,
      "exec '/repo/apps/desktop/.electron-runtime/Apna Tasks (Dev).app/Contents/MacOS/Electron'",
    );
