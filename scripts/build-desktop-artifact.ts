...
const DESKTOP_APP_ID = "com.apnatasks.desktop";
...
export function resolveDesktopProductName(version: string): string {
  return resolveDesktopUpdateChannel(version) === "nightly"
    ? "Apna Tasks (Nightly)"
    : (desktopPackageJson.productName ?? "Apna Tasks");
}
...
export const createBuildConfig = Effect.fn("createBuildConfig")(function* (
  ...
  if (platform === "mac") {
    buildConfig.mac = {
      ...
      protocols: [
        {
          name: "Apna Tasks",
          schemes: ["apnatasks", "apnatasks-dev"],
        },
      ],
      ...(macPasskeySigning
        ? {
  ...
  if (platform === "linux") {
    buildConfig.linux = {
      ...
      // apnatasks:// OAuth callbacks to the app.
      protocols: [
        {
          name: "Apna Tasks",
          schemes: ["apnatasks", "apnatasks-dev"],
...
const buildDesktopArtifact = Effect.fn("buildDesktopArtifact")(function* (
  ...
  const stagePackageJson: StagePackageJson = {
    ...
    description: "Apna Tasks desktop build",
    author: "T3 Tools",
...
const buildDesktopArtifactCli = Command.make("build-desktop-artifact", {
  ...
  Command.withDescription("Build a desktop artifact for Apna Tasks."),
